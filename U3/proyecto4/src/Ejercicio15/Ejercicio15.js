      ...
      <div className="tarjeta">
        ...
        <form className="paquete">
          <div className="mb-3 alinear">
            ...
            <input onChange={(e) => GuardarDatos(e)} id="nombreRemitente" name='nombreRemitente' type="text" className="form-control" />
          </div>
          <div
            className="mb-3"
          ...
          >
            ...
            <textarea onChange={(e) => GuardarDatos(e)} id="direccionRemitente" name='direccionRemitente' className="form-control" />
          </div>
          <div className="mb-3 alinear">
            <label htmlFor="nombreDestinatario" className="form-label">
              Nombre del Destinatario:
            </label>
            <input onChange={(e) => GuardarDatos(e)}
          ...
          >
            ...
            <textarea onChange={(e) => GuardarDatos(e)} id="direccionDestinatario" name='direccionDestinatario' className="form-control" />
          </div>
          <div className="mb-3 alinear">
            <label htmlFor="peso" className="form-label">
              Peso del Paquete (kg):
            </label>
            <input onChange={(e) => GuardarDatos(e)} id="peso" type="number" name='peso' className="form-control" />
          </div>
