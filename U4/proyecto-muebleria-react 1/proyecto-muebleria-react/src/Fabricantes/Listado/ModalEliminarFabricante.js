...
export default function ModalEliminarFabricante({ mostrar, item, handleCerrar }) {
    ...
    const eliminaFabricante = async () => {
      try {
        ...
        const response = await axios.delete(
          "https://localhost:7152/Muebleria/EliminarFabricante?idFabricanteEliminar=" +
            item.idFabricante,
        );
        ...
        <div className="modal-dialog">
          <div className="modal-content">
            ...
            <div className="modal-footer">
              ...
              <button type="button" className="btn btn-danger" onClick={ () => eliminaFabricante()}>
                Eliminar
              </button>
            </div>
          </div>
