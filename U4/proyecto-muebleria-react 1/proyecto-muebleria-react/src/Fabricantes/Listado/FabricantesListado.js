...
export default function FabricantesListado() {
  ...
  const [itemFabricante, setitemSeleccionada] = useState({
    idFabricante: 0,
    nombre: "",
  });
    ...
    const obtenListadoFabricantes = async () => {
      try {
        ...
        const response = await axios.get(
          "https://localhost:7232/Muebleria/ListadoFabricantes",
        );
  ...
  return (
    <div className="container-fluid">
      ...
      <div style={{ textAlign: "right" }} className="mb-3">
        <a href="/FabricantesListado/Nuevo" className="btn btn-success">
          Nuevo Fabricante
        </a>
      </div>
